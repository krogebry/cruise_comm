class FamilyMembersController < ApplicationController
  ...
  def index
	...
	@family_members.each do |member|
		if(member.room_id != nil)
			if(FamComm::Application.config.rooms.has_key?( member.room_id ))
				member['room_name'] = FamComm::Application.config.rooms[member.room_id]['name']
			end
		end
	end
  ...
  def new
	...
	@rooms = FamComm::Application.config.rooms
